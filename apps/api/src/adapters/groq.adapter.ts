...
import type { ServicioIA } from './servicio-ia';
...
export class GroqAdapter implements ServicioIA {
  async buscarProductos(consulta: string, productosDisponibles: Product[]): Promise<Product[]> {
