  ...
  await prisma.product.createMany({
    data: [
      ...
      },
      {
        ...
        imagePath:
          'https://www.sony.com.bo/image/6145c1d32e6ac8e63a46c912dc33c5bb?fmt=pjpeg&wid=330&bgcolor=FFFFFF&bgc=FFFFFF',
        price: 249990,
        categoryId: electronica.id,
        supplierId: supplier.id,
        activeState: true,
      ...
      },
      {
        ...
        description:
          'Tecnología que absorbe el sudor. Tejido transpirable, corte estándar, 100% poliéster. Disponible en varios colores.',
        imagePath:
